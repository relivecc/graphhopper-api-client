...
// @ts-ignore
import { GetSolution404Response } from '../model';
// @ts-ignore
...
export const ClusterAPIApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        asyncClusteringProblem: async (clusterRequest: ClusterRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'clusterRequest' is not null or undefined
            assertParamExists('asyncClusteringProblem', 'clusterRequest', clusterRequest)
         ...
         * @throws {RequiredError}
         */
        getClusterSolution: async (jobId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jobId' is not null or undefined
            assertParamExists('getClusterSolution', 'jobId', jobId)
         ...
         * @throws {RequiredError}
         */
        solveClusteringProblem: async (clusterRequest: ClusterRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'clusterRequest' is not null or undefined
            assertParamExists('solveClusteringProblem', 'clusterRequest', clusterRequest)
...
export const ClusterAPIApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async asyncClusteringProblem(clusterRequest: ClusterRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<JobId>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.asyncClusteringProblem(clusterRequest, options);
         ...
         * @throws {RequiredError}
         */
        async getClusterSolution(jobId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ClusterResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getClusterSolution(jobId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         *  The Cluster endpoint is used with a POST request towards `https://graphhopper.com/api/1/cluster?key=<your_key>`. The solution will be provided in the JSON response. Please note that for problems that take longer than 10 seconds a bad request error is returned. In this case please use the asynchronous [Batch Cluster Endpoint](#operation/asyncClusteringProblem) instead. 
         ...
         * @throws {RequiredError}
         */
        async solveClusteringProblem(clusterRequest: ClusterRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ClusterResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.solveClusteringProblem(clusterRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const ClusterAPIApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        asyncClusteringProblem(requestParameters: ClusterAPIApiAsyncClusteringProblemRequest, options?: AxiosRequestConfig): AxiosPromise<JobId> {
            return localVarFp.asyncClusteringProblem(requestParameters.clusterRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * This endpoint returns the solution of the clustering problems submitted to the [Batch Cluster endpoint](#operation/asyncClusteringProblem). You can fetch it with the job_id, you have been sent. 
         * @summary GET Batch Solution Endpoint
         ...
         * @throws {RequiredError}
         */
        getClusterSolution(requestParameters: ClusterAPIApiGetClusterSolutionRequest, options?: AxiosRequestConfig): AxiosPromise<ClusterResponse> {
            return localVarFp.getClusterSolution(requestParameters.jobId, options).then((request) => request(axios, basePath));
        },
        /**
         *  The Cluster endpoint is used with a POST request towards `https://graphhopper.com/api/1/cluster?key=<your_key>`. The solution will be provided in the JSON response. Please note that for problems that take longer than 10 seconds a bad request error is returned. In this case please use the asynchronous [Batch Cluster Endpoint](#operation/asyncClusteringProblem) instead. 
         * @summary POST Cluster Endpoint
         ...
         * @throws {RequiredError}
         */
        solveClusteringProblem(requestParameters: ClusterAPIApiSolveClusteringProblemRequest, options?: AxiosRequestConfig): AxiosPromise<ClusterResponse> {
            return localVarFp.solveClusteringProblem(requestParameters.clusterRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ClusterAPIApi extends BaseAPI {
     ...
     */
    public asyncClusteringProblem(requestParameters: ClusterAPIApiAsyncClusteringProblemRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof ClusterAPIApi
     */
    public getClusterSolution(requestParameters: ClusterAPIApiGetClusterSolutionRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof ClusterAPIApi
     */
    public solveClusteringProblem(requestParameters: ClusterAPIApiSolveClusteringProblemRequest, options?: AxiosRequestConfig) {

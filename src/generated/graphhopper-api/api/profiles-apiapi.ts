...
// @ts-ignore
import { ProfileGetResponse } from '../model';
// @ts-ignore
import { ProfileRequest } from '../model';
// @ts-ignore
import { ProfileResponse } from '../model';
/**
 * ProfilesAPIApi - axios parameter creator
 * @export
 */
export const ProfilesAPIApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Use DELETE /profiles/my_profile_id to delete the custom profile \"my_profile_id\"
         * @summary Deleting custom routing profiles
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteProfile: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
        ...
        /**
         * Use GET /profiles to get your existing custom profiles
        ...
        /**
         * Use POST /profiles to create custom profiles
         * @summary Creating custom routing profiles
         * @param {ProfileRequest} profileRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        postProfile: async (profileRequest: ProfileRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'profileRequest' is not null or undefined
            assertParamExists('postProfile', 'profileRequest', profileRequest)
            const localVarPath = `/profiles`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
/**
 * ProfilesAPIApi - functional programming interface
 * @export
 */
export const ProfilesAPIApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ProfilesAPIApiAxiosParamCreator(configuration)
    return {
        /**
         * Use DELETE /profiles/my_profile_id to delete the custom profile \"my_profile_id\"
         * @summary Deleting custom routing profiles
         ...
         * @throws {RequiredError}
         */
        async deleteProfile(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async getProfile(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProfileGetResponse>> {
         ...
         * @throws {RequiredError}
         */
        async postProfile(profileRequest: ProfileRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProfileResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.postProfile(profileRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * ProfilesAPIApi - factory interface
 * @export
 */
export const ProfilesAPIApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ProfilesAPIApiFp(configuration)
    return {
        /**
         * Use DELETE /profiles/my_profile_id to delete the custom profile \"my_profile_id\"
         * @summary Deleting custom routing profiles
         ...
         * @throws {RequiredError}
         */
        deleteProfile(options?: AxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        getProfile(options?: AxiosRequestConfig): AxiosPromise<ProfileGetResponse> {
            return localVarFp.getProfile(options).then((request) => request(axios, basePath));
        },
        /**
         * Use POST /profiles to create custom profiles
         * @summary Creating custom routing profiles
         * @param {ProfilesAPIApiPostProfileRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        postProfile(requestParameters: ProfilesAPIApiPostProfileRequest, options?: AxiosRequestConfig): AxiosPromise<ProfileResponse> {
            return localVarFp.postProfile(requestParameters.profileRequest, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for postProfile operation in ProfilesAPIApi.
 * @export
 * @interface ProfilesAPIApiPostProfileRequest
 */
export interface ProfilesAPIApiPostProfileRequest {
    /**
     * 
     * @type {ProfileRequest}
     * @memberof ProfilesAPIApiPostProfile
     */
    readonly profileRequest: ProfileRequest
}

/**
 * ProfilesAPIApi - object-oriented interface
 * @export
 * @class ProfilesAPIApi
 * @extends {BaseAPI}
 */
export class ProfilesAPIApi extends BaseAPI {
    /**
     * Use DELETE /profiles/my_profile_id to delete the custom profile \"my_profile_id\"
     * @summary Deleting custom routing profiles
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ProfilesAPIApi
     */
    public deleteProfile(options?: AxiosRequestConfig) {
        return ProfilesAPIApiFp(this.configuration).deleteProfile(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getProfile(options?: AxiosRequestConfig) {
        return ProfilesAPIApiFp(this.configuration).getProfile(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProfilesAPIApi
     */
    public postProfile(requestParameters: ProfilesAPIApiPostProfileRequest, options?: AxiosRequestConfig) {
        return ProfilesAPIApiFp(this.configuration).postProfile(requestParameters.profileRequest, options).then((request) => request(this.axios, this.basePath));
    }
}

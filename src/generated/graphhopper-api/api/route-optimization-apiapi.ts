...
export const RouteOptimizationAPIApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {Request} request The request that contains the problem to be solved.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        asyncVRP: async (request: Request, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'request' is not null or undefined
            assertParamExists('asyncVRP', 'request', request)
         ...
         * @throws {RequiredError}
         */
        getSolution: async (jobId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jobId' is not null or undefined
            assertParamExists('getSolution', 'jobId', jobId)
         ...
         * @param {Request} request The request that contains the vehicle routing problem to be solved.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        solveVRP: async (request: Request, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'request' is not null or undefined
            assertParamExists('solveVRP', 'request', request)
...
export const RouteOptimizationAPIApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = RouteOptimizationAPIApiAxiosParamCreator(configuration)
    return {
        /**
         *  To solve a vehicle routing problem, perform the following steps:  1.) Make a HTTP POST to this URL  ``` https://graphhopper.com/api/1/vrp/optimize?key=<your_key> ```  It returns a job id (job_id).  2.) Take the job id and fetch the solution for the vehicle routing problem from this URL:  ``` https://graphhopper.com/api/1/vrp/solution/<job_id>?key=<your_key> ```  We recommend to query the solution every 500ms until it returns \'status=finished\'.  **Note**: Since the workflow is a bit more cumbersome and since you lose some time in fetching the solution, you should always prefer the [synchronous endpoint](#operation/solveVRP). You should use the batch mode only for long running problems. 
         * @summary POST route optimization problem (batch mode)
         ...
         * @throws {RequiredError}
         */
        async asyncVRP(request: Request, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<JobId>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.asyncVRP(request, options);
         ...
         * @throws {RequiredError}
         */
        async getSolution(jobId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getSolution(jobId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         *  To get started with the Route Optimization API, please read the [introduction](#tag/Route-Optimization-API).  To solve a new vehicle routing problem, make a HTTP POST to this URL  ``` https://graphhopper.com/api/1/vrp?key=<your_key> ```  It returns the solution to this problem in the JSON response.  Please note that this URL is very well suited to solve minor problems. Larger vehicle routing problems, which take longer than 10 seconds to solve, cannot be solved. To solve them, please use the [batch mode URL](#operation/asyncVRP) instead. 
         ...
         * @throws {RequiredError}
         */
        async solveVRP(request: Request, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.solveVRP(request, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const RouteOptimizationAPIApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = RouteOptimizationAPIApiFp(configuration)
    return {
        /**
         *  To solve a vehicle routing problem, perform the following steps:  1.) Make a HTTP POST to this URL  ``` https://graphhopper.com/api/1/vrp/optimize?key=<your_key> ```  It returns a job id (job_id).  2.) Take the job id and fetch the solution for the vehicle routing problem from this URL:  ``` https://graphhopper.com/api/1/vrp/solution/<job_id>?key=<your_key> ```  We recommend to query the solution every 500ms until it returns \'status=finished\'.  **Note**: Since the workflow is a bit more cumbersome and since you lose some time in fetching the solution, you should always prefer the [synchronous endpoint](#operation/solveVRP). You should use the batch mode only for long running problems. 
         * @summary POST route optimization problem (batch mode)
         ...
         * @throws {RequiredError}
         */
        asyncVRP(requestParameters: RouteOptimizationAPIApiAsyncVRPRequest, options?: AxiosRequestConfig): AxiosPromise<JobId> {
            return localVarFp.asyncVRP(requestParameters.request, options).then((request) => request(axios, basePath));
        },
        /**
         *  Take the job id and fetch the solution for the vehicle routing problem from this URL:  ``` https://graphhopper.com/api/1/vrp/solution/<job_id>?key=<your_key> ```  You get the job id by sending a vehicle routing problem to the [batch mode URL](#operation/asyncVRP). 
         * @summary GET the solution (batch mode)
         ...
         * @throws {RequiredError}
         */
        getSolution(requestParameters: RouteOptimizationAPIApiGetSolutionRequest, options?: AxiosRequestConfig): AxiosPromise<Response> {
            return localVarFp.getSolution(requestParameters.jobId, options).then((request) => request(axios, basePath));
        },
        /**
         *  To get started with the Route Optimization API, please read the [introduction](#tag/Route-Optimization-API).  To solve a new vehicle routing problem, make a HTTP POST to this URL  ``` https://graphhopper.com/api/1/vrp?key=<your_key> ```  It returns the solution to this problem in the JSON response.  Please note that this URL is very well suited to solve minor problems. Larger vehicle routing problems, which take longer than 10 seconds to solve, cannot be solved. To solve them, please use the [batch mode URL](#operation/asyncVRP) instead. 
         * @summary POST route optimization problem
         ...
         * @throws {RequiredError}
         */
        solveVRP(requestParameters: RouteOptimizationAPIApiSolveVRPRequest, options?: AxiosRequestConfig): AxiosPromise<Response> {
            return localVarFp.solveVRP(requestParameters.request, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class RouteOptimizationAPIApi extends BaseAPI {
     ...
     */
    public asyncVRP(requestParameters: RouteOptimizationAPIApiAsyncVRPRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof RouteOptimizationAPIApi
     */
    public getSolution(requestParameters: RouteOptimizationAPIApiGetSolutionRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof RouteOptimizationAPIApi
     */
    public solveVRP(requestParameters: RouteOptimizationAPIApiSolveVRPRequest, options?: AxiosRequestConfig) {

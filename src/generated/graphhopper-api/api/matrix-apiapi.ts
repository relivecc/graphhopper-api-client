...
export const MatrixAPIApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        calculateMatrix: async (matrixRequestSymmetricalMatrixRequest?: MatrixRequest | SymmetricalMatrixRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(matrixRequestSymmetricalMatrixRequest, localVarRequestOptions, configuration)
         ...
         * @param {Array<'any' | 'right' | 'left'>} [fromCurbside] Curbside setting for the from_point parameter. See curbside.
         * @param {Array<'any' | 'right' | 'left'>} [toCurbside] Curbside setting for the to_point parameter. See curbside.
         ...
         * @throws {RequiredError}
         */
        getMatrix: async (profile?: string, point?: Array<string>, fromPoint?: Array<string>, toPoint?: Array<string>, pointHint?: Array<string>, fromPointHint?: Array<string>, toPointHint?: Array<string>, snapPrevention?: Array<string>, curbside?: Array<'any' | 'right' | 'left'>, fromCurbside?: Array<'any' | 'right' | 'left'>, toCurbside?: Array<'any' | 'right' | 'left'>, outArray?: Array<string>, failFast?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        postMatrix: async (matrixRequestSymmetricalMatrixRequest?: MatrixRequest | SymmetricalMatrixRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/matrix`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const MatrixAPIApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async calculateMatrix(matrixRequestSymmetricalMatrixRequest?: MatrixRequest | SymmetricalMatrixRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<JobId>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.calculateMatrix(matrixRequestSymmetricalMatrixRequest, options);
         ...
         * @throws {RequiredError}
         */
        async getMatrix(profile?: string, point?: Array<string>, fromPoint?: Array<string>, toPoint?: Array<string>, pointHint?: Array<string>, fromPointHint?: Array<string>, toPointHint?: Array<string>, snapPrevention?: Array<string>, curbside?: Array<'any' | 'right' | 'left'>, fromCurbside?: Array<'any' | 'right' | 'left'>, toCurbside?: Array<'any' | 'right' | 'left'>, outArray?: Array<string>, failFast?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MatrixResponse>> {
         ...
         * @throws {RequiredError}
         */
        async getMatrixSolution(jobId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MatrixResponse>> {
         ...
         * @throws {RequiredError}
         */
        async postMatrix(matrixRequestSymmetricalMatrixRequest?: MatrixRequest | SymmetricalMatrixRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MatrixResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.postMatrix(matrixRequestSymmetricalMatrixRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const MatrixAPIApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        calculateMatrix(matrixRequestSymmetricalMatrixRequest?: MatrixRequest | SymmetricalMatrixRequest, options?: any): AxiosPromise<JobId> {
            return localVarFp.calculateMatrix(matrixRequestSymmetricalMatrixRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * With this Matrix Endpoint you submit the points and parameters via URL parameters and is the most convenient as it works out-of-the-box in the browser. If possible you should prefer using the [POST Matrix Endpoint](#operation/postMatrix) that avoids problems with many locations and can also gzip the **request**. (Note, that all endpoints return gzipped responses). 
         * @summary GET Matrix Endpoint
         ...
         * @throws {RequiredError}
         */
        getMatrix(profile?: string, point?: Array<string>, fromPoint?: Array<string>, toPoint?: Array<string>, pointHint?: Array<string>, fromPointHint?: Array<string>, toPointHint?: Array<string>, snapPrevention?: Array<string>, curbside?: Array<'any' | 'right' | 'left'>, fromCurbside?: Array<'any' | 'right' | 'left'>, toCurbside?: Array<'any' | 'right' | 'left'>, outArray?: Array<string>, failFast?: boolean, options?: any): AxiosPromise<MatrixResponse> {
            return localVarFp.getMatrix(profile, point, fromPoint, toPoint, pointHint, fromPointHint, toPointHint, snapPrevention, curbside, fromCurbside, toCurbside, outArray, failFast, options).then((request) => request(axios, basePath));
        },
        /**
         * This endpoint returns the solution of a JSON submitted to the Batch Matrix endpoint. You can fetch it with the job_id, you have been sent. 
         * @summary GET Batch Matrix Endpoint
        ...
        getMatrixSolution(jobId: string, options?: any): AxiosPromise<MatrixResponse> {
            return localVarFp.getMatrixSolution(jobId, options).then((request) => request(axios, basePath));
        },
        /**
         *  The [GET endpoint](#operation/getMatrix) has an URL length limitation, which hurts for many locations per request. In those cases use this POST endpoint with a JSON as input. The only parameter in the URL will be the key. Both request scenarios are identical except that all singular parameter names are named as their plural for a POST request. The effected parameters are: `points`, `from_points`, `to_points`, and `out_arrays`. For the remaining parameters please refer to the [guide of the GET endpoint](#operation/getMatrix).  **Please note that in contrast to GET endpoint the points have to be specified as `[longitude, latitude]` array (in that order, similar to [GeoJson](http://geojson.org/geojson-spec.html#examples))**.  For example the query `point=10,11&point=20,22&profile=car` will be converted to the following JSON: ```json { \"points\": [[11,10], [22,20]], \"profile\": \"car\" } ```  A complete curl Example: ```bash curl -X POST -H \"Content-Type: application/json\" \"https://graphhopper.com/api/1/matrix?key=[YOUR_KEY]\" -d \'{\"elevation\":false,\"out_arrays\":[\"weights\", \"times\"],\"from_points\":[[-0.087891,51.534377],[-0.090637,51.467697],[-0.171833,51.521241],[-0.211487,51.473685]],\"to_points\":[[-0.087891,51.534377],[-0.090637,51.467697],[-0.171833,51.521241],[-0.211487,51.473685]],\"vehicle\":\"car\"}\' ``` 
         * @summary POST Matrix Endpoint
        ...
        postMatrix(matrixRequestSymmetricalMatrixRequest?: MatrixRequest | SymmetricalMatrixRequest, options?: any): AxiosPromise<MatrixResponse> {
            return localVarFp.postMatrix(matrixRequestSymmetricalMatrixRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export interface MatrixAPIApiGetMatrixRequest {
     ...
     * @memberof MatrixAPIApiGetMatrix
     */
    readonly fromCurbside?: Array<'any' | 'right' | 'left'>
     ...
     * @memberof MatrixAPIApiGetMatrix
     */
    readonly toCurbside?: Array<'any' | 'right' | 'left'>

...
// @ts-ignore
import { GetMatrixSolution200Response } from '../model';
// @ts-ignore
import { JobId } from '../model';
// @ts-ignore
import { MatrixResponse } from '../model';
// @ts-ignore
import { PostMatrixRequest } from '../model';
/**
...
export const MatrixAPIApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {PostMatrixRequest} [postMatrixRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        calculateMatrix: async (postMatrixRequest?: PostMatrixRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(postMatrixRequest, localVarRequestOptions, configuration)
         ...
         * @param {Array<string>} [snapPrevention] Optional parameter to avoid snapping to a certain road class or road environment. Current supported values &#x60;motorway&#x60;, &#x60;trunk&#x60;, &#x60;ferry&#x60;, &#x60;tunnel&#x60;, &#x60;bridge&#x60; and &#x60;ford&#x60;. Multiple values are specified like &#x60;snap_prevention&#x3D;ferry&amp;snap_prevention&#x3D;motorway&#x60;. Please note that this feature does not e.g. avoid motorways for the route - it only avoids it for the \&quot;location snap\&quot;. 
         * @param {Array<GetMatrixCurbsideEnum>} [curbside] Optional parameter. It specifies on which side a point should be relative to the driver when she leaves/arrives at a start/target/via point. You need to specify this parameter for either none or all points. Only supported for motor vehicles and OpenStreetMap.
         * @param {Array<GetMatrixFromCurbsideEnum>} [fromCurbside] Curbside setting for the from_point parameter. See curbside.
         * @param {Array<GetMatrixToCurbsideEnum>} [toCurbside] Curbside setting for the to_point parameter. See curbside.
         ...
         * @throws {RequiredError}
         */
        getMatrix: async (profile?: string, point?: Array<string>, fromPoint?: Array<string>, toPoint?: Array<string>, pointHint?: Array<string>, fromPointHint?: Array<string>, toPointHint?: Array<string>, snapPrevention?: Array<string>, curbside?: Array<GetMatrixCurbsideEnum>, fromCurbside?: Array<GetMatrixFromCurbsideEnum>, toCurbside?: Array<GetMatrixToCurbsideEnum>, outArray?: Array<string>, failFast?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            if (fromCurbside) {
                localVarQueryParameter['from_curbside'] = fromCurbside;
            }

            if (toCurbside) {
                localVarQueryParameter['to_curbside'] = toCurbside;
            }
         ...
         * @throws {RequiredError}
         */
        getMatrixSolution: async (jobId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jobId' is not null or undefined
            assertParamExists('getMatrixSolution', 'jobId', jobId)
...
export const MatrixAPIApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = MatrixAPIApiAxiosParamCreator(configuration)
    return {
        /**
         * Prefer the [synchronous endpoint](#operation/postMatrix) and use this Batch endpoint for long running problems only.  The Batch Matrix endpoint allows using matrices with more locations and works asynchronously - similar to the [Batch Route Optimization endpoint](#operation/asyncVRP):  * Create a HTTP POST request against `/matrix/calculate` and add the key in the URL: `/matrix/calculate?key=[YOUR_KEY]`. This will give you the `job_id` from the response json like `{ \"job_id\": \"7ac65787-fb99-4e02-a832-2c3010c70097\" }`  * Poll via HTTP GET requests every 500ms against `/matrix/solution/[job_id]`  Here are some full examples via curl: ```bash $ curl -X POST -H \"Content-Type: application/json\" \"https://graphhopper.com/api/1/matrix/calculate?key=[YOUR_KEY]\" -d \'{\"points\":[[13.29895,52.48696],[13.370876,52.489575],[13.439026,52.511206]]}\' {\"job_id\":\"7ac65787-fb99-4e02-a832-2c3010c70097\"} ```  Pick the returned `job_id` and use it in the next GET requests: ```bash $ curl -X GET \"https://graphhopper.com/api/1/matrix/solution/7ac65787-fb99-4e02-a832-2c3010c70097?key=[YOUR_KEY]\" {\"status\":\"waiting\"} ```  When the calculation is finished (`status:finished`) the JSON response will contain the full matrix JSON under `solution`: ```bash $ curl -X GET \"https://graphhopper.com/api/1/matrix/solution/7ac65787-fb99-4e02-a832-2c3010c70097?key=[YOUR_KEY]\" {\"solution\":{\"weights\":[[0.0,470.453,945.414],[503.793,0.0,580.871],[970.49,569.511,0.0]],\"info\":{\"copyrights\":[\"GraphHopper\",\"OpenStreetMap contributors\"]}},\"status\":\"finished\"} ```  Please note that if an error occured while calculation the JSON will not have a status but contain directly the error message e.g.: ```json {\"message\":\"Cannot find from_points: 1\"} ``` And the optional `hints` array. 
         * @summary Batch Matrix Endpoint
         ...
         * @throws {RequiredError}
         */
        async calculateMatrix(postMatrixRequest?: PostMatrixRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<JobId>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.calculateMatrix(postMatrixRequest, options);
         ...
         * @throws {RequiredError}
         */
        async getMatrix(profile?: string, point?: Array<string>, fromPoint?: Array<string>, toPoint?: Array<string>, pointHint?: Array<string>, fromPointHint?: Array<string>, toPointHint?: Array<string>, snapPrevention?: Array<string>, curbside?: Array<GetMatrixCurbsideEnum>, fromCurbside?: Array<GetMatrixFromCurbsideEnum>, toCurbside?: Array<GetMatrixToCurbsideEnum>, outArray?: Array<string>, failFast?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MatrixResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getMatrix(profile, point, fromPoint, toPoint, pointHint, fromPointHint, toPointHint, snapPrevention, curbside, fromCurbside, toCurbside, outArray, failFast, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * This endpoint returns the solution of a JSON submitted to the Batch Matrix endpoint. You can fetch it with the job_id, you have been sent. 
         ...
         * @throws {RequiredError}
         */
        async getMatrixSolution(jobId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetMatrixSolution200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getMatrixSolution(jobId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         *  The [GET endpoint](#operation/getMatrix) has an URL length limitation, which can be problematic if a request includes many locations. In those cases use this POST endpoint with a JSON as input. The only parameter in the URL will be the key. Both request scenarios are identical except that all singular parameter names are named as their plural for a POST request. The effected parameters are: `points`, `from_points`, `to_points`, and `out_arrays`. For the remaining parameters please refer to the [guide of the GET endpoint](#operation/getMatrix).  **Please note that in contrast to GET endpoint the points have to be specified as `[longitude, latitude]` array (in that order, similar to [GeoJson](http://geojson.org/geojson-spec.html#examples))**.  For example the query `point=10,11&point=20,22&profile=car` will be converted to the following JSON: ```json { \"points\": [[11,10], [22,20]], \"profile\": \"car\" } ```  A complete curl Example: ```bash curl -X POST -H \"Content-Type: application/json\" \"https://graphhopper.com/api/1/matrix?key=[YOUR_KEY]\" -d \'{\"elevation\":false,\"out_arrays\":[\"weights\", \"times\"],\"from_points\":[[-0.087891,51.534377],[-0.090637,51.467697],[-0.171833,51.521241],[-0.211487,51.473685]],\"to_points\":[[-0.087891,51.534377],[-0.090637,51.467697],[-0.171833,51.521241],[-0.211487,51.473685]],\"profile\":\"car\"}\' ``` 
         ...
         * @throws {RequiredError}
         */
        async postMatrix(postMatrixRequest?: PostMatrixRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MatrixResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.postMatrix(postMatrixRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const MatrixAPIApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = MatrixAPIApiFp(configuration)
    return {
        /**
         * Prefer the [synchronous endpoint](#operation/postMatrix) and use this Batch endpoint for long running problems only.  The Batch Matrix endpoint allows using matrices with more locations and works asynchronously - similar to the [Batch Route Optimization endpoint](#operation/asyncVRP):  * Create a HTTP POST request against `/matrix/calculate` and add the key in the URL: `/matrix/calculate?key=[YOUR_KEY]`. This will give you the `job_id` from the response json like `{ \"job_id\": \"7ac65787-fb99-4e02-a832-2c3010c70097\" }`  * Poll via HTTP GET requests every 500ms against `/matrix/solution/[job_id]`  Here are some full examples via curl: ```bash $ curl -X POST -H \"Content-Type: application/json\" \"https://graphhopper.com/api/1/matrix/calculate?key=[YOUR_KEY]\" -d \'{\"points\":[[13.29895,52.48696],[13.370876,52.489575],[13.439026,52.511206]]}\' {\"job_id\":\"7ac65787-fb99-4e02-a832-2c3010c70097\"} ```  Pick the returned `job_id` and use it in the next GET requests: ```bash $ curl -X GET \"https://graphhopper.com/api/1/matrix/solution/7ac65787-fb99-4e02-a832-2c3010c70097?key=[YOUR_KEY]\" {\"status\":\"waiting\"} ```  When the calculation is finished (`status:finished`) the JSON response will contain the full matrix JSON under `solution`: ```bash $ curl -X GET \"https://graphhopper.com/api/1/matrix/solution/7ac65787-fb99-4e02-a832-2c3010c70097?key=[YOUR_KEY]\" {\"solution\":{\"weights\":[[0.0,470.453,945.414],[503.793,0.0,580.871],[970.49,569.511,0.0]],\"info\":{\"copyrights\":[\"GraphHopper\",\"OpenStreetMap contributors\"]}},\"status\":\"finished\"} ```  Please note that if an error occured while calculation the JSON will not have a status but contain directly the error message e.g.: ```json {\"message\":\"Cannot find from_points: 1\"} ``` And the optional `hints` array. 
         * @summary Batch Matrix Endpoint
         ...
         * @throws {RequiredError}
         */
        calculateMatrix(requestParameters: MatrixAPIApiCalculateMatrixRequest = {}, options?: AxiosRequestConfig): AxiosPromise<JobId> {
            return localVarFp.calculateMatrix(requestParameters.postMatrixRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * With this Matrix Endpoint you submit the points and parameters via URL parameters and is the most convenient as it works out-of-the-box in the browser. If possible you should prefer using the [POST Matrix Endpoint](#operation/postMatrix) that avoids problems with many locations and can also gzip the **request**. (Note, that all endpoints return gzipped responses). 
         * @summary GET Matrix Endpoint
         ...
         * @throws {RequiredError}
         */
        getMatrix(requestParameters: MatrixAPIApiGetMatrixRequest = {}, options?: AxiosRequestConfig): AxiosPromise<MatrixResponse> {
            return localVarFp.getMatrix(requestParameters.profile, requestParameters.point, requestParameters.fromPoint, requestParameters.toPoint, requestParameters.pointHint, requestParameters.fromPointHint, requestParameters.toPointHint, requestParameters.snapPrevention, requestParameters.curbside, requestParameters.fromCurbside, requestParameters.toCurbside, requestParameters.outArray, requestParameters.failFast, options).then((request) => request(axios, basePath));
        },
        /**
         * This endpoint returns the solution of a JSON submitted to the Batch Matrix endpoint. You can fetch it with the job_id, you have been sent. 
         * @summary GET Batch Matrix Endpoint
         ...
         * @throws {RequiredError}
         */
        getMatrixSolution(requestParameters: MatrixAPIApiGetMatrixSolutionRequest, options?: AxiosRequestConfig): AxiosPromise<GetMatrixSolution200Response> {
            return localVarFp.getMatrixSolution(requestParameters.jobId, options).then((request) => request(axios, basePath));
        },
        /**
         *  The [GET endpoint](#operation/getMatrix) has an URL length limitation, which can be problematic if a request includes many locations. In those cases use this POST endpoint with a JSON as input. The only parameter in the URL will be the key. Both request scenarios are identical except that all singular parameter names are named as their plural for a POST request. The effected parameters are: `points`, `from_points`, `to_points`, and `out_arrays`. For the remaining parameters please refer to the [guide of the GET endpoint](#operation/getMatrix).  **Please note that in contrast to GET endpoint the points have to be specified as `[longitude, latitude]` array (in that order, similar to [GeoJson](http://geojson.org/geojson-spec.html#examples))**.  For example the query `point=10,11&point=20,22&profile=car` will be converted to the following JSON: ```json { \"points\": [[11,10], [22,20]], \"profile\": \"car\" } ```  A complete curl Example: ```bash curl -X POST -H \"Content-Type: application/json\" \"https://graphhopper.com/api/1/matrix?key=[YOUR_KEY]\" -d \'{\"elevation\":false,\"out_arrays\":[\"weights\", \"times\"],\"from_points\":[[-0.087891,51.534377],[-0.090637,51.467697],[-0.171833,51.521241],[-0.211487,51.473685]],\"to_points\":[[-0.087891,51.534377],[-0.090637,51.467697],[-0.171833,51.521241],[-0.211487,51.473685]],\"profile\":\"car\"}\' ``` 
         * @summary POST Matrix Endpoint
         ...
         * @throws {RequiredError}
         */
        postMatrix(requestParameters: MatrixAPIApiPostMatrixRequest = {}, options?: AxiosRequestConfig): AxiosPromise<MatrixResponse> {
            return localVarFp.postMatrix(requestParameters.postMatrixRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export interface MatrixAPIApiCalculateMatrixRequest {
    /**
     * 
     * @type {PostMatrixRequest}
     * @memberof MatrixAPIApiCalculateMatrix
     */
    readonly postMatrixRequest?: PostMatrixRequest
}
...
export interface MatrixAPIApiGetMatrixRequest {
     ...
     * @memberof MatrixAPIApiGetMatrix
     */
    readonly curbside?: Array<GetMatrixCurbsideEnum>
     ...
     * @memberof MatrixAPIApiGetMatrix
     */
    readonly fromCurbside?: Array<GetMatrixFromCurbsideEnum>
     ...
     * @memberof MatrixAPIApiGetMatrix
     */
    readonly toCurbside?: Array<GetMatrixToCurbsideEnum>
...
export class MatrixAPIApi extends BaseAPI {
     ...
     */
    public calculateMatrix(requestParameters: MatrixAPIApiCalculateMatrixRequest = {}, options?: AxiosRequestConfig) {
        return MatrixAPIApiFp(this.configuration).calculateMatrix(requestParameters.postMatrixRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof MatrixAPIApi
     */
    public getMatrix(requestParameters: MatrixAPIApiGetMatrixRequest = {}, options?: AxiosRequestConfig) {
        return MatrixAPIApiFp(this.configuration).getMatrix(requestParameters.profile, requestParameters.point, requestParameters.fromPoint, requestParameters.toPoint, requestParameters.pointHint, requestParameters.fromPointHint, requestParameters.toPointHint, requestParameters.snapPrevention, requestParameters.curbside, requestParameters.fromCurbside, requestParameters.toCurbside, requestParameters.outArray, requestParameters.failFast, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof MatrixAPIApi
     */
    public getMatrixSolution(requestParameters: MatrixAPIApiGetMatrixSolutionRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof MatrixAPIApi
     */
    public postMatrix(requestParameters: MatrixAPIApiPostMatrixRequest = {}, options?: AxiosRequestConfig) {
        return MatrixAPIApiFp(this.configuration).postMatrix(requestParameters.postMatrixRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
 ...
 * @export
 */
export const GetMatrixCurbsideEnum = {
    Any: 'any',
    Right: 'right',
    Left: 'left'
} as const;
export type GetMatrixCurbsideEnum = typeof GetMatrixCurbsideEnum[keyof typeof GetMatrixCurbsideEnum];
/**
 * @export
 */
export const GetMatrixFromCurbsideEnum = {
    Any: 'any',
    Right: 'right',
    Left: 'left'
} as const;
export type GetMatrixFromCurbsideEnum = typeof GetMatrixFromCurbsideEnum[keyof typeof GetMatrixFromCurbsideEnum];
/**
 * @export
 */
export const GetMatrixToCurbsideEnum = {
    Any: 'any',
    Right: 'right',
    Left: 'left'
} as const;
export type GetMatrixToCurbsideEnum = typeof GetMatrixToCurbsideEnum[keyof typeof GetMatrixToCurbsideEnum];
